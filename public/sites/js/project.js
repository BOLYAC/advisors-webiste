...
document.addEventListener('DOMContentLoaded', function () {
  ...
  $('.gallery').owlCarousel({
    ...
    loop: true,
    nav: true,
    navText: ["<div class='tparrows tp-leftarrow'></div>", "<div class='tparrows tp-rightarrow'></div>"],
    responsive: {
      0: {
        items: 1,
        stagePadding: 10
...
module.exports = __webpack_require__(/*! D:\projects\turkeyadvisors\resources\js\project.js */"./resources/js/project.js");
