...
document.addEventListener('DOMContentLoaded', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    var $grid = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.grid').isotope({
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-button-group').on('click', 'a', function () {
      var filterValue = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-filter');
      filterValue = filterValue === '*' ? filterValue : '.' + filterValue;
      $grid.isotope({
        filter: filterValue
      });
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.filter-button-group a').removeClass('active');
...
module.exports = __webpack_require__(/*! D:\projects\turkeyadvisors\resources\js\search.js */"./resources/js/search.js");
