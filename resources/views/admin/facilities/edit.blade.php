                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" id="title-en" name="en[title]"
                                   placeholder="{{ __('Title for the page') }}" value="{{ old('en:title', optional($facility->translate('en'))->title) }}">
                        </div>
                    </div>
                    <div class="form-group row" dir="rtl">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" id="title-ar" name="ar[title]"
                                   placeholder="{{ __('Title for the page') }}" value="{{ old('ar:title', optional($facility->translate('ar'))->title) }}">
                        </div>
                    </div>
