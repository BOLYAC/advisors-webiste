    ...
    <form action="{{ route('settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-group" dir="rtl">
                <label class="control-label" for="seo_meta_title">SEO Meta Title [ العربية ]</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Enter seo meta title for store"
                    id="seo_meta_title"
                    name="ar[seo_meta_title]"
                    value="{{ optional($setting->translate('ar'))->seo_meta_title ?? '' }}"
                />
            </div>
            <div class="form-group">
            ...
            <div class="form-group" dir="rtl">
                <label class="control-label" for="footer_copyright_text">Footer Copyright Text [ العربية ]</label>
                <textarea
                    class="form-control"
                    rows="4"
                    placeholder="Enter footer copyright text"
                    id="footer_copyright_text"
                    name="ar[footer_copyright_text]"
                >{{ optional($setting->translate('ar'))->footer_copyright_text ?? '' }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" dir="rtl">
                <label class="control-label" for="seo_meta_description">SEO Meta Description [ العربية ]</label>
                <textarea
                    class="form-control"
                    rows="4"
                    placeholder="Enter seo meta description for store"
                    id="seo_meta_description"
                    name="ar[seo_meta_description]"
                >{{ optional($setting->translate('ar'))->seo_meta_description ?? '' }}</textarea>
            </div>
        </div>
        <!-- Form Submission -->
