...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col">
                <h2 class="content-heading">{{ __('Edit post') }}</h2>
            </div>
        </div>
        <div class="row">
            <div class="col">
                ...
                <div class="block">
                    <ul class="nav nav-tabs nav-tabs-block align-items-center" data-toggle="tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="#btabswo-static-home">{{__('Post details')}}</a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="title" name="en[title]"
                                               ...
                                               value="{{  optional($post->translate('en'))->title  }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="title_ar" name="ar[title]"
                                               dir="rtl"
                                               placeholder="{{ __('Title for the page') }}"
                                               value="{{ optional($post->translate('ar'))->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <textarea class="editors" id="js-ckeditor"
                                                  name="en[details]">{!! optional($post->translate('en'))->details !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <textarea id="js-ckeditor-ar"
                                                  name="ar[details]">{!! optional($post->translate('ar'))->details !!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="seo_title_en"
                                                       ...
                                                       value="{{ optional($post->translate('en'))->seo_title }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="seo_url_slug_en"
                                                       ...
                                                       value="{{ optional($post->translate('en'))->seo_url_slug }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <textarea class="form-control" id="seo_description_en"
                                                      name="en[seo_description]">{!!  optional($post->translate('en'))->seo_description !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <textarea class="form-control" id="seo_keywords"
                                                      name="en[seo_keywords]">{!! optional($post->translate('en'))->seo_keywords !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div
                                            ...
                                            <h4 class="h5 mb-5">
                                                <a id="title_in_engines_en"
                                                   href="{{ config('app.url'). '/' . $post->translate('en')->seo_url_slug ?? '' }}"
                                                   target="_blank">{{ $post->translate('en')->seo_title }}</a>
                                            </h4>
                                            <div id="url_in_engines_en"
                                                 class="font-sm text-earth mb-5"> {{ config('app.url'). '/' . $post->translate('en')->seo_url_slug ?? '' }}</div>
                                            <p id="desc_in_engines_en"
                                               class="font-sm text-muted">{!! $post->translate('en')->seo_description ?? '' !!}</p>
                                        </div>
                                        ...
                                        <div class="form-group row " dir="rtl">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="seo_title_ar"
                                                       ...
                                                       data-slug="#lang-en"
                                                       placeholder="{{ __('Seo title') }}"
                                                       value="{{ optional($post->translate('ar'))->seo_title }}">
                                            </div>
                                        </div>
                                        <div class="form-group row " dir="rtl">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="seo_url_slug_ar"
                                                       ...
                                                       placeholder="{{ __('Friendly URL') }}"
                                                       value="{{ optional($post->translate('ar'))->seo_url_slug }}">
                                            </div>
                                        </div>
                                        <div class="form-group row " dir="rtl">
                                            ...
                                            <textarea class="form-control" id="seo_description_ar"
                                                      name="ar[seo_description]">{!! optional($post->translate('ar'))->seo_description !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row " dir="rtl">
                                            ...
                                            <textarea class="form-control" id="seo_keywords_ar"
                                                      name="ar[seo_keywords]">{!! optional($post->translate('ar'))->seo_keywords !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div
                                            ...
                                            <h4 class="h5 mb-5">
                                                <a id="title_in_engines_ar"
                                                   href="{{ config('app.url'). '/' . optional($post->translate('ar'))->seo_url_slug }}"
                                                   target="_blank">{{ optional($post->translate('ar'))->seo_title }}</a>
                                            </h4>
                                            <div id="url_in_engines_ar"
                                                 class="font-sm text-earth mb-5"> {{ config('app.url'). '/' . optional($post->translate('ar'))->seo_url_slug }}</div>
                                            <p id="desc_in_engines_ar"
                                               class="font-sm text-muted">{!! optional($post->translate('ar'))->seo_description !!}</p>
                                        </div>
                                        <div class="form-group">
                                            <div class="mt-3">
                                                <i class="fa fa-info"></i>
                ...
                <script>
                    ...
                    $("#seo_title_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#title_in_engines_en").text("{{ optional($post->translate('en'))->seo_title }}");
                        }
                    ...
                    $("#seo_description_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#desc_in_engines_en").text("{{ optional($post->translate('en'))->seo_description }}");
                        }
                    });
                    $("#seo_url_slug_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            $("#url_in_engines_en").text("<?php echo url(''); ?>/blog/" + slugify($(this).val()));
                        } else {
                            $("#url_in_engines_en").text("{{ config('app.url'). '/blog/' . optional($post->translate('en'))->seo_url_slug }}");
                        }
                    });
                    $("#seo_title_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#title_in_engines_ar").text("{{ optional($post->translate('ar'))->seo_title }}");
                        }
                    });
                    $("#seo_description_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#desc_in_engines_ar").text("{{ optional($post->translate('ar'))->seo_description }}");
                        }
                    });
                    $("#seo_url_slug_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            $("#url_in_engines_ar").text("<?php echo url(''); ?>/blog/" + slugify($(this).val()));
                        } else {
                            $("#url_in_engines_ar").text("{{ config('app.url'). '/blog/' . optional($post->translate('ar'))->seo_url_slug }}");
                        }
                    });
                </script>
@endsection
