                ...
                <div class="block">
                    <form action="{{ route('site-pages.update',$topic) }}" method="post" enctype="multipart/form-data">
                            ...
                            @foreach(LaravelLocalization::getSupportedLocales() as $locale => $properties)
                                <div class="tab-pane fade show {{ $loop->first ? 'active' : '' }}"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-12"
                                               for="title_en">{{ __('Title') . " " ."(" . $locale . ")" }}</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control" id="title" name="{{$locale}}[title]"
                                                   placeholder="{{ __('Title for the page') }}"
                                                   value="{{  optional($topic->translate($locale))->title  }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <textarea class="editors" id="js-ckeditor_{{$locale}}"
                                                      name="{{$locale}}[details]">{!! optional($topic->translate($locale))->details !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12"
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" id="seo_title_{{$locale}}"
                                                   ...
                                                   value="{{ optional($topic->translate($locale))->seo_title }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12"
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" id="seo_url_slug_{{$locale}}"
                                                   ...
                                                   value="{{ optional($topic->translate($locale))->seo_url_slug }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12"
                      ...
                      <textarea class="form-control" id="seo_description_{{$locale}}"
                                name="{{$locale}}[seo_description]">{!!  optional($topic->translate($locale))->seo_description !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-12"
                                               for="seo_keywords">{{ __('Meta Keywords') . " " ."(" . $locale . ")" }}</label>
                                        <!-- CKEditor Container -->
                                        <div class="col-12">
                      <textarea class="form-control" id="seo_keywords_{{$locale}}"
                                name="{{$locale}}[seo_keywords]">{!! optional($topic->translate($locale))->seo_keywords !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
