...
<div class="content">
  <nav class="breadcrumb bg-white push">
    ...
    <a class="breadcrumb-item" href="{{ route('site-pages.index') }}">{{ __('List site pages') }}</a>
    <span class="breadcrumb-item active">{{ __('Edit page') }}</span>
  </nav>
  <!-- Block Tabs With Options -->
  <div class="row">
    <div class="col">
      <h2 class="content-heading">{{ __('Edit page') }}</h2>
    </div>
  </div>
  <div class="row">
    <div class="col">
      ...
      <div class="block">
        ...
        <form action="{{ route('site-pages.update',$topic) }}" method="post" enctype="multipart/form-data">
          @csrf
          @method('PUT')
              ...
              <div class="form-group row">
                ...
                <div class="col-md-12">
                  <input type="text" class="form-control" id="title" name="en[title]"
                    ...
                    value="{{  optional($topic->translate('en'))->title  }}">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-12">
                  <input type="text" class="form-control" id="title_ar" name="ar[title]" dir="rtl"
                    placeholder="{{ __('Title for the page') }}" value="{{ optional($topic->translate('ar'))->title }}">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-12">
                  ...
                  <textarea class="editors" id="js-ckeditor"
                    name="en[details]">{!! optional($topic->translate('en'))->details !!}</textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-12">
                  ...
                  <textarea id="js-ckeditor-ar"
                    name="ar[details]">{!! optional($topic->translate('ar'))->details !!}</textarea>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-12">
                  <div class="custom-file">
                    <input type="file" class="photo_file" id="example-file-input-custom" name="photo_file"
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="seo_title_en" name="en[seo_title]"
                        placeholder="{{ __('Seo title') }}" value="{{ optional($topic->translate('en'))->seo_title }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="seo_url_slug_en" name="en[seo_url_slug]"
                        placeholder="{{ __('Friendly URL') }}"
                        value="{{ optional($topic->translate('en'))->seo_url_slug }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="seo_description_en"
                        name="en[seo_description]">{!!  optional($topic->translate('en'))->seo_description !!}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="seo_keywords"
                        name="en[seo_keywords]">{!! optional($topic->translate('en'))->seo_keywords !!}</textarea>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <div
                    ...
                    <h4 class="h5 mb-5">
                      <a id="title_in_engines_en"
                        href="{{ config('app.url'). '/' . $topic->translate('en')->seo_url_slug ?? '' }}"
                        target="_blank">{{ $topic->translate('en')->seo_title }}</a>
                    </h4>
                    <div id="url_in_engines_en" class="font-sm text-earth mb-5">
                      {{ config('app.url'). '/' . $topic->translate('en')->seo_url_slug ?? '' }}</div>
                    <p id="desc_in_engines_en" class="font-sm text-muted">{!! $topic->translate('en')->seo_description
                      ?? '' !!}</p>
                  </div>
                ...
                <div class="col-6">
                  <div class="form-group row " dir="rtl">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="seo_title_ar" name="ar[seo_title]"
                        data-slug="#lang-en" placeholder="{{ __('Seo title') }}"
                        value="{{ optional($topic->translate('ar'))->seo_title }}">
                    </div>
                  </div>
                  <div class="form-group row " dir="rtl">
                    ...
                    <div class="col-12">
                      <input type="text" class="form-control" id="seo_url_slug_ar" name="ar[seo_url_slug]"
                        placeholder="{{ __('Friendly URL') }}"
                        value="{{ optional($topic->translate('ar'))->seo_url_slug }}">
                    </div>
                  </div>
                  <div class="form-group row " dir="rtl">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="seo_description_ar"
                        name="ar[seo_description]">{!! optional($topic->translate('ar'))->seo_description !!}</textarea>
                    </div>
                  </div>
                  <div class="form-group row " dir="rtl">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="seo_keywords_ar"
                        name="ar[seo_keywords]">{!! optional($topic->translate('ar'))->seo_keywords !!}</textarea>
                    </div>
                  </div>
                </div>
                  ...
                  <div
                    ...
                    <h4 class="h5 mb-5">
                      <a id="title_in_engines_ar"
                        href="{{ config('app.url'). '/' . optional($topic->translate('ar'))->seo_url_slug }}"
                        target="_blank">{{ optional($topic->translate('ar'))->seo_title }}</a>
                    </h4>
                    <div id="url_in_engines_ar" class="font-sm text-earth mb-5">
                      {{ config('app.url'). '/' . optional($topic->translate('ar'))->seo_url_slug }}</div>
                    <p id="desc_in_engines_ar" class="font-sm text-muted">{!!
                      optional($topic->translate('ar'))->seo_description !!}</p>
                  </div>
                  <div class="form-group">
                    <div class="mt-3">
                      <i class="fa fa-info"></i>
      ...
      jQuery(function () {
                    ...
                    $("#seo_title_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#title_in_engines_en").text("{{ optional($topic->translate('en'))->seo_title }}");
                        }
                    ...
                    $("#seo_description_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#desc_in_engines_en").text("{{ optional($topic->translate('en'))->seo_description }}");
                        }
                    });
                    $("#seo_url_slug_en").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#url_in_engines_en").text("{{ config('app.url'). '/' . optional($topic->translate('en'))->seo_url_slug }}");
                        }
                    });
                    $("#seo_title_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#title_in_engines_ar").text("{{ optional($topic->translate('ar'))->seo_title }}");
                        }
                    });
                    $("#seo_description_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#desc_in_engines_ar").text("{{ optional($topic->translate('ar'))->seo_description }}");
                        }
                    });
                    $("#seo_url_slug_ar").on('keyup change', function () {
                        if ($(this).val() !== "") {
                            ...
                            $("#url_in_engines_ar").text("{{ config('app.url'). '/' . optional($topic->translate('ar'))->seo_url_slug }}");
                        }
                    });
    </script>
    @endsection