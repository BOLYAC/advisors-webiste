@extends('layouts.app')
@section('title')
    {{ __('messages.contact_us') }} | Turkey Advisors
@endsection
@section('stylesheets')
    @if (App::getLocale() == 'ar')
...
@section('javascripts')
    ...
    <script type="text/javascript">
        function initMap() {
            var zoom = 15;
            var latitude = 36.18179489344718;
            var longitude = 5.429649263889179;
            ...
            <div class="col-lg-5">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-outline-primary btn-lg px-5">{{ __('messages.submit') }} <span class="arrow2 is-triangle arrow-bar is-right"></span></button>
                    </div>
                </form>
            </div>
        </div>
