            ...
            <div class="banner-content d-flex align-items-center">
                <div class="container d-flex align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <div class="banner-text d-inline-flex font-weight-bold"
                         style="right:10px;">{{ __('الجنسية التركية ') }}
                        <br/>{{ __('من خلال الاستثمار العقاري ') }}</div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                                ...
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{ __('يحتل الإقتصاد التركي مركزية') }}<br/>
                                            {{ __(' مهمة عالمياً') }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-4 mb-4 mb-lg-5">
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{ __('تركيا تمتلك قطاع صحة وتامين ممتاز') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4 mb-4 mb-lg-5">
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{__('تركيا تمتلك  بنية تحتية قوية متطورة')}}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4 mb-4 mb-lg-5">
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{ __('استطاع السوق التركي جذب أكبر ') }}
                                            <br>
                                            {{ __('روؤس الأموال العالمية ورجال الاعمال') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4 mb-4 mb-lg-5">
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{ __('نظام الضرائب في تركيا صمم لخدمتك') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4 mb-4 mb-lg-5">
                                <div class="stat">
                                    ...
                                    <div class="stat-content">
                                        ...
                                        <div class="stat-text text-center">
                                            {{ __('القيمة السوقية والاستثمارية ') }}
                                            <br>
                                            {{ __('للأسواق التركية بتطور تصاعدي قوي') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-11 col-xl-10 col-xxl-9">
                        <h2 class="mt-5">{{ __('اهم الاحصائيات و الاستبيانات العقاريه التي يجب عليك الاطلاع عليها لشهر يناير2022  ') }}</h2>
                        <ul>
                            <li class="mb-3">{{ __('شهد سوق العقارات والانشاء الاستثماري في تركيا تزايد المبيعات بنسب كبيرة مقارنة بـ يناير العام الماضي 2021, وقد حقق مبيعات الأجانب ايضاً نسبة تصاعدية ملحوظة بنسبة ال 77,1% في جميع المدن التركية, وتم بيع  أكثر من 7,841 عقار خلال شهر يناير 2022
') }}
                            </li>
                            <li class="mb-3">{{ __('حقق المستثمرين الإيرانين المرتبة الأولى من حيث عدد الإستثمارات والعقارات المباعة, حيث تم بيع أكثر من 1,462 عقار ضمن مختلف المدن التركية, اسطنبول في المرتبة الأولى, ليليها من انطاليا وأنقرة العاصمة') }}
                            </li>
                            <li class="mb-3">{{ __('وفي المرتية الثانية حقق المستثمرين من الجنسية العراقية ثاني أكبر نسبة من حيث عدد العقارات المباعة, حيث تم بيع اكثر من 1,039 في مختلف المدن التركية, اسطنبول احتلت المرتبة الأولى ايضاً') }}</li>
                            <li class="mb-3">{{ __('أمّا المرتبة الثالثة فقد احتلها المستثمرين الروس, من حيث عدد العقارات المباعة 885 عقار في مختلف المدن التركية اسطنبول في المرتبة الأولى تليها انطاليا, ازمير , وبوردروم
') }}</li>
                            <li class="mb-3">{{ __(' 7,841عقار مباع هو إجمالي عدد العقارات المباعة للأجانب في تركيا لشهر يناير 2022 مايعادل زيادة ملحوظة نسبياً في إجمالي عدد العقارات بنسبة الـ 77,1% مقارنة بشهر يناير العام الفائت 2021 ') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="section contact-section section-height-3">
            <div class="container">
                <p class="mb-5">
                    {{ __('يتيح القانون التركي فرصة الحصول على الجنسية التركية من خلال الإستثمار العقاري بقيمة الــ 250,000$,أو بنكي بقيمة $500.000 ولكن من المتوقع تعديل قرار منح الجنسية التركية للمستثمرين الأجانب والذي تم اصداره عام 2018, ليتم رفع قيمة الإستثمار العقاري للقيمة الــ $500,000, لذا لاتفوت فرصة الحصول على الجنسية التركية ومنحها للعائلتك, ضمن افضل بقاع العالم, تركيا') }}
                </p>
                <div class="row justify-content-center mb-5">
                    <div class="col-lg-6 text-center">
                        <a href="#" class="btn btn-gradient px-4 px-sm-5 py-2 py-sm-3 fw-bold">
                            {{ __('انضم للنادي النخبة اليوم') }}
                        </a>
                    </div>
                </div>
                <h4 class="text-center fw-bold mb-5">
                    {{ __('اغتم فرصة الحصول على الإستشارات العقارية والقانونية مجاناً
بإضافة إلى فرصة الحصول على جولة افتراضية أين ماكنت حول العالم') }}
                </h4>
                <div class="row justify-content-center">
                    <div class="col-lg-9 text-center">
                        <div class="card card-rounded">
                            <div class="card-body shadow-lg">
                                <h2 class="mb-5">{{ __('تواصل معنا') }}</h2>
                                <form action="{{ route('submit.contact') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6 mb-5">
                                            <input
                                                ...
                                                name="email"
                                                placeholder="{{ __('البريد الاكتروني') }}" required>
                                            @if ($errors->has('email'))
                                                <div class="error">
                                                    {{ $errors->first('email') }}
                                                </div>
                                        ...
                                        <div class="form-group col-6 mb-5" dir="ltr">
                                            <input
                                                ...
                                                name="phone"
                                                type="text"
                                                placeholder="{{ __('رقم الهاتف') }}" required>
                                            @if ($errors->has('phone'))
                                                <div class="error">
                                                    {{ $errors->first('phone') }}
                                                </div>
                                    ...
                                    <div class="form-group mb-5">
                                        <textarea class="form-control form-control-lg" rows="3"
                                                  name="message"
                                                  placeholder="{{ __('رسالتك') }}"></textarea>
                                    </div>
                                    <div class="form-group pt-4 pt-xs-5">
                                        <button type="submit"
                                                class="btn btn-gradient px-5 py-2">{{ __('للمزيد من المعلومات') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <section class="section projects-section section-height-2">
            <div class="container">
                <h2 class="text-uppercase">{{ __('المشاريع الموصى بها') }}</h2>
                <div class="projects">
                    <div class="project pt-3 pb-4 p-3 p-md-5">
                        ...
                        <div class="price-container text-center mb-3 mb-lg-4">
                            <div class="starts-from">{{ __('تبدأ من') }}</div>
                            <div class="price text-secondary text-center">$500.000</div>
                        </div>
                        <div class="project-footer text-center">
                            <span class="d-block text-light mb-1 mb-sm-2">{{ __('للمزيد من المعلومات') }}</span>
                            <a class="btn btn-gradient px-3 px-sm-4 px-md-5 py-0 py-sm-1 py-md-2 select-the-project"
                               ...
                               data-id="https://www.turkeyadvisors.com/projects/ta124">{{ __('استفسار سريع') }}</a>
                    ...
                    <div class="project pt-3 pb-4 p-3 p-md-5">
                        ...
                        <div class="project-footer text-center">
                            ...
                            <a class="btn btn-gradient px-3 px-sm-4 px-md-5 py-0 py-sm-1 py-md-2"
                               data-bs-toggle="modal" data-bs-target="#inquiry-project" data-bs-container="body"
                               data-bs-trigger="hover focus" data-bs-placement="right" data-bs-content="Right popover"
                               data-id="https://www.turkeyadvisors.com/projects/ta127">{{ __('استفسار سريع') }}</a>
                            <div class="project-city d-flex align-items-center">
                                <img src="{{ asset('sites/img/landing-page/project-city.png') }}" alt=""
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="text-uppercase my-0 py-0">{{ __('تواصل معنا') }}</h3>
                    ...
                    <div class="modal-body py-4">
                        ...
                        <textarea name="message" class="form-control form-control-lg" rows="3"
                            ...
                            <div>
                                <button type="submit"
                                        class="btn btn-primary text-secondary w-100 btn-lg px-5">{{ __('للمزيد من المعلومات') }}
