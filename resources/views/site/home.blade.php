        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xl-2 text-start text-lg-end mb-3">
                    <a class="btn btn-secondary btn-secondary-animated btn-lg px-5 px-lg-0 w-auto-mobile w-100">{{ __('messages.projects') }}
    ...
    <section class="section articles-section my-0 pb-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xl-2 text-start text-lg-end mb-3">
                    <a class="btn btn-secondary btn-secondary-animated btn-lg px-5 px-lg-0 w-auto-mobile w-100">{{ __('messages.articles') }}
                        <span class="arrow2 is-triangle arrow-bar is-right"></span></a>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="pr-5">
                        ...
                        <div class="more-details d-inline-block mb-4">
                            <a href="/" class="btn btn-primary btn-line text-4 px-5">{{ __('messages.about_us') }}</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="section services-section my-0">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-xl-2 text-start text-lg-end mb-3">
                    <a class="btn btn-secondary btn-secondary-animated btn-lg px-5 px-lg-0 w-auto-mobile w-100">{{ __('messages.services') }}
                        <span class="arrow2 is-triangle arrow-bar is-right"></span></a>
                </div>
            </div>
            <div class="row mt-4">
                    ...
                    <div class="service col-md-6 col-xl-3 mb-4">
                        <div class="card">
                            ...
                            <span class="icon-border">
                                ...
                                <h4 class="card-title my-3">A name you can trust</h4>
                                <p class="card-text">We have served hundreds of satified and happy clients from all over
