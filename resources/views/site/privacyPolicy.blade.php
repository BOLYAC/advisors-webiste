...
@section('content')
    <section class="page-header page-header-modern page-header-background page-header-background-sm mb-5" style="background-image: url({{ asset('sites/img/background.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-md-12 align-self-center p-static order-2 text-center">
                    <h1 class="mt-3 text-uppercase">{{ __('messages.privacy_policy') }}</h1>
                ...
                <div class="col-md-12 align-self-center order-1">
                    <ul class="breadcrumb breadcrumb-light d-block text-center">
                        ...
                        <li class="active">{{ __('messages.privacy_policy') }}</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container py-2">
        <div class="row">
            <div class="col">
                <h2>Privacy Policy For Turkey Advidsor</h2>
